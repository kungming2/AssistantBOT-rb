...
This page is for maintainers working on the Devvit/TypeScript app. The main [README](../README.md) is kept focused on installing Artemis and understanding how this port differs from the old Python/PRAW bot.
...
- `artemis-record-monthly-stats`: monthly top-post-by-score and top-post-by-comments statistics refresh after midnight UTC on the first day of the month.
...
```text
docs/
|-- index.md                   # Documentation index for GitHub links
|-- deprecated.md              # Deprecated Python-era behavior and statistics sections
|-- development.md             # Maintainer notes
`-- faq.md                     # Moderator-facing FAQ
src/
